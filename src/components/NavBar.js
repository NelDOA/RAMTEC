            ...
            <div className="relative bg-white font-ubuntu">
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-5 ">
                        ...
                        <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                            <NavLink to="#" className=" font-sen text-quinto text-sm font-semibold hover:text-tercero">Iniciar sesión</NavLink>
                            <NavLink to="#" className=" ml-3 whitespace-nowrap inline-flex items-center justify-center px-2 py-2 border border-transparent rounded-md shadow-md text-sm font-semibold text-white bg-quinto hover:bg-cuarto">Registrarse</NavLink>
                        </div>
                    </div>
                </div>
                {/* MOBILE MENU :) ORALE! */}
                <div className={`animate__animated z-10 absolute top-0 inset-x-0 p-2 md:hidden ${hidden}`}>
                    <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                        ...
                        <div>
                            <a href="#" className=" w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-quinto hover:bg-cuarto">Registrarse</a>
                                <p className="mt-6 text-center text-base font-medium text-gray-500">
                                    Usuario registrado?
                                <a href="#" className=" text-primero hover:text-cuarto"> Iniciar sesión</a>
                            </p>
                        </div>
                        </div>
                    </div>
