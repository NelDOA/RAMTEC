...
const NavBarItemOptionsOption = ( {option} ) => {
    return (
        <>
            <a href={option.href} className="transition ease-in-out delay-50 -m-3 p-2 flex items-start rounded-lg hover:text-white hover:bg-cuarto">
